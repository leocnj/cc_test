...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="dataset.csv", help="Path to dataset CSV")
    ...
    train_dataset = TextClassificationDataset(
        csv_path=train_path, tokenizer=tokenizer, max_length=config["data"]["max_length"]
    )
